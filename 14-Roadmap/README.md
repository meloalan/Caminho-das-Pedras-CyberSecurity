...
Avance por entregas, não por prazo fixo. Linux e Windows acompanham os fundamentos; MITRE e resposta a incidentes atravessam a trilha.

| Nível | Estudos | Entrega mínima |
| --- | --- | --- |
| 1 — [Fundamentos de TI](../01-Fundamentos/README.md) | Hardware, sistemas operacionais, virtualização, Git/GitHub e linha de comando | Inventário de VM e primeira nota versionada |
...
- [Iniciante](iniciante.md): níveis 1–3 e primeiros eventos Windows.
- [Intermediário](intermediario.md): níveis 4–5, coleta e correlação.
- [Avançado](avancado.md): níveis 6–7, validação e hunting.

## Ciclo de portfólio

Aprender → Praticar → Documentar → Criar Portfólio. Cada entrega deve ter uma pergunta, procedimento reproduzível, evidência real anonimizada, conclusão e limitações.
